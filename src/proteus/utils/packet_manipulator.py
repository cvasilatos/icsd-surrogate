...
def inject_mutation(target_field: RawField, base_payload_hex: str, mutation_hex: str, unique_fields: list[RawField], adapter: ProtocolAdapter | None = None) -> bytearray:
